...
class LosslessJpegTurboRotate90CounterClockwiseOperation : MediaStoreEditOperation {
    override val name: String = "Rotate"
    override val confirmationMessage: String =
        "Rotate this JPEG 90° counter-clockwise (true lossless DCT transform)?\n\n" +
    ...
    override fun apply(resolver: ContentResolver, imageUri: Uri) {
        ...
        val outBytes = JpegTurboNative.rotate90CounterClockwiseLosslessJpeg(inBytes, exifOrientation)
